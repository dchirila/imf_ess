...
contains
  type(Config) function createConfig( cfgFilePath )
    ...
    ! .....................................................
    read(cfgFileID,*) createConfig%mTempA
    read(cfgFileID,*) createConfig%mTempB
    read(cfgFileID,*) createConfig%mTempC
    read(cfgFileID,*) createConfig%mTempD
    read(cfgFileID,*) createConfig%mNx
    read(cfgFileID,*) createConfig%mDiffusivity
    read(cfgFileID,*) createConfig%mSideLength
    close(cfgFileID)
...
program solve_heat_diffusion_v1
  ...
  character(len=200) :: configFile = "config_file_formatted.in", &
...
end program solve_heat_diffusion_v1
