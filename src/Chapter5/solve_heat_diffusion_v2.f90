! File: solve_heat_diffusion_v2.f90
...
!          This version also demonstrates how to use a namelist-file for reading
!          the simulation parameters (more convenient/flexible approach, compared
!          to file 'Chapter4/solve_heat_diffusion.f90').
...
contains
  ...
  subroutine writeAscii( this, outFilePath )
    ...
    write(outFileID, '(a)') &
         "# output file for program solve_heat_diffusion_v2.f90"
...
program solve_heat_diffusion_v2
  use NumericKinds
  use Solver_class
  implicit none
...
end program solve_heat_diffusion_v2
